...
const slide = [
   ...
   },
   {
      ...
      description:
         "Кондиционеры, объединяющие один внешний блок с несколькими внутренними, позволяя кондиционировать несколько помещений одновременно",
   },
   {
      img: semiIndustrial,
      title: "Полупромышленные сплит-системы",
      description:
         "Мощные кондиционеры, предназначенные для кондиционирования больших помещений, таких как магазины, офисы, рестораны",
   },
   {
      img: VRF,
      title: "VRF-системы",
